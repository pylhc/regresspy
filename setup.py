...
ABOUT_REGRESSPY = about_package(ABOUT_FILE)
...
setuptools.setup(
    name=ABOUT_REGRESSPY["__title__"],
    version=ABOUT_REGRESSPY["__version__"],
    description=ABOUT_REGRESSPY["__description__"],
    long_description=long_description,
    long_description_content_type="text/markdown",
    author=ABOUT_REGRESSPY["__author__"],
    author_email=ABOUT_REGRESSPY["__author_email__"],
    url=ABOUT_REGRESSPY["__url__"],
    packages=setuptools.find_packages(include=(MODULE_NAME,)),
    include_package_data=True,
    python_requires=">=3.6",
    license=ABOUT_REGRESSPY["__license__"],
    classifiers=[
